...
export const resourceHintPlans = [
  {
    ...
    summary: 'Resolve the stylesheet host before the server shell asks for remote font CSS.',
  },
  {
    id: 'hint-connection',
    api: 'preconnect',
    target: 'https://fonts.gstatic.com',
    summary: 'Open the font asset connection early so follow-up requests skip the connection handshake.',
  },
  {
    id: 'hint-image',
    api: 'preload',
    target: '/hydration/diagram.svg',
    summary: 'Fetch a concrete image asset while the existing HTML shell is still being hydrated.',
  },
  {
    id: 'hint-style',
    api: 'preinit',
    target: '/hydration/critical.css',
    summary: 'Prepare a stylesheet before the hydrated UI reveals the comparison and status panels.',
  },
  {
    id: 'hint-module-preload',
    api: 'preloadModule',
    target: '/hydration/preview-module.js',
    summary: 'Start fetching a module graph ahead of a client-only follow-up interaction.',
  },
  {
    id: 'hint-module-preinit',
    api: 'preinitModule',
    target: '/hydration/preview-module.js',
    summary: 'Prepare the module script so evaluation can begin immediately once code imports it.',
  },
...
export function findResourceHintPlan(id: ResourceHintId) {
  return resourceHintPlans.find((plan) => plan.id === id) ?? resourceHintPlans[0]
}
