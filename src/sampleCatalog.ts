...
export const miniSampleCatalog = [
  {
    ...
    summary: 'The current app demonstrates the modern client-side APIs that fit cleanly into one cohesive example.',
    whyIsolated: 'This stays integrated because the hooks reinforce each other in one shared user flow.',
  },
  {
    ...
    summary: 'Build a focused theme or feature-flag sample to show provider setup and consumer reads.',
    whyIsolated: 'Context changes app-wide behavior and becomes noisy if it is mixed into every other demo.',
  },
  {
    ...
    surface: 'isolated-route',
    apis: ['useReducer'],
    summary: 'Model state transitions explicitly with actions and reducer logic.',
    whyIsolated: 'Reducers deserve their own domain model instead of being bolted onto the optimistic form sample.',
  },
  {
    ...
    whyIsolated: 'Performance demos are easiest to understand when render causes are visible in isolation.',
  },
  {
    ...
    whyIsolated: 'Layout timing samples depend on precise DOM sequencing and should not compete with other demos.',
  },
  {
    ...
    whyIsolated: 'The mental model is different from ordinary hooks and deserves a dedicated async boundary.',
  },
  {
    ...
    whyIsolated: 'Portals are best explained with a dedicated host layer instead of a crowded demo page.',
  },
  {
    ...
    surface: 'isolated-route',
    apis: ['useFormStatus'],
    summary: 'Show form-scoped pending state without threading props down from the form shell.',
    whyIsolated: 'It is easier to learn when the button and form status relationship is the whole example.',
  },
  {
    ...
    summary: 'Hydrate server markup and coordinate network and asset hints around that entry point.',
  ...
  },
  {
    ...
    summary: 'Compare Node and web-stream server rendering strategies and where resume/prerender APIs fit.',
    whyIsolated: 'These APIs need a server runtime and should be built as a separate SSR workspace, not a client sample.',
  },
  {
    ...
    status: 'deferred',
    surface: 'separate-entry',
    apis: ['Server Components', 'Server Functions', '\'use client\'', '\'use server\''],
    summary: 'Demonstrate server/client boundaries and file-level directives in a framework-aware environment.',
    whyIsolated: 'These patterns are environment-specific and should not be faked inside a plain Vite client app.',
  },
  {
    ...
    summary: 'Show compiler setup, generated behavior, and when directives change optimization decisions.',
    whyIsolated: 'Compiler configuration affects the whole build and should be tested in a contained workspace.',
  },
  {
    ...
    whyIsolated: 'Type manipulation examples are clearer when the runtime UI is tiny and the types are the main subject.',
  },
  {
    ...
    whyIsolated: 'Function-shape examples are easier to reason about when the demo is a focused API surface.',
  },
  {
    ...
    whyIsolated: 'Classes bring a different style than the functional React code, so they should not be mixed into app state.',
  },
  {
    ...
    whyIsolated: 'Declaration authoring is library-facing work and is cleaner in a node-only package-style example.',
  },
  {
    ...
    summary: 'Show how TypeScript can type-check JavaScript without a full rewrite.',
    whyIsolated: 'JS interop has separate compiler settings and should live away from the TS-first app code.',
  },
  {
    ...
    status: 'deferred',
    surface: 'node-only',
    apis: ['enums', 'symbols', 'iterators', 'mixins', 'decorators', 'namespaces'],
    summary: 'Explore the lesser-used corners of the language and compare which ones still make sense in modern TS.',
    whyIsolated: 'These topics are niche and should not dilute the main learning path before the core language samples exist.',
  },
